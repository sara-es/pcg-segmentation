...
class PatientInfo: 
    ...
    def __init__(self, dataset_dir):
        ...
        self.info_dict = {"ID": [], "Filename": [], "Raw_WAV": [], "Frequency" : [], "TSV": [], "Clipped_WAV" : [], "Segmentations": [], "CNN_Data": [] }
    ...
    def update_CNN_data(self):
        ...
        self.info_dict["CNN_Data"].append(CNNData(np.array(x_patches), np.array(y_patches), self.info_dict["Filename"][-1], range(0, len(x_patches))))