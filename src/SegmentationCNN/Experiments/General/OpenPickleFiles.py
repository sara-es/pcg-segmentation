...
# TODO
for i in range(1, 6):
    with open('/Users/serenahuston/GitRepos/ThirdYearProject/Results/HMM_vs_CNN_22_03_2023/cnn_results_22_03_23__'+str(i), 'rb') as f:
        cnn_results = pickle.load(f)
    with open('/Users/serenahuston/GitRepos/ThirdYearProject/Results/HMM_vs_CNN_22_03_2023/hmm_results_22_03_23__'+str(i), 'rb') as f:
